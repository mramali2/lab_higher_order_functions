...
describe('ScranAdvisor', () => {
    ...
    test('can find Happy Lamb Hot Pot restaurant by full name', () => {
        ...
        const actual = scranAdvisor.findRestaurantByName("Happy Lamb Hot Pot")[0];
    ...
    test('can find the name of all restaurants', () => {
        const expected = [
          ...
          const actual = scranAdvisor.restaurantNames();
          expect(actual).toEqual(expected);
    })
    ...
    test('can find all restaurants from Glasgow', () => {
        const expected = [
          ...
          const actual = scranAdvisor.filterByCity('Glasgow');
          expect(actual).toEqual(expected);
    })
